...
**Note:** This fork is Meteor 1.3-ready. It uses Node 0.10.43 by default.  The branched named 1.4 will be 1.4-ready soon (I'll reflect this much here when it's ready).
...
- [Creating a Meteor Up Classic Project](#creating-a-meteor-up-classic-project)
...
**Note:** These instructions are for installing the main branch (which is 1.3 compatible) of meteor-up-classic.
...
**Note:** Or alternatively
    ...
    git clone https://github.com/aadamsx/meteor-up-classic.git
