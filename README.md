...
**NEW:** A new mupc-1.5 branch as been added.  Please see that branch for details.
...
**Note:** Or alternatively
    ...
    git clone -b master --single-branch https://github.com/aadamsx/meteor-up-classic.git
